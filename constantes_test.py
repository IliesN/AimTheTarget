...
BOUTON_RETOUR_ACC_RECT = IMAGE_BOUTON_RETOUR_ACC.get_rect()
BOUTON_RETOUR_ACC_RECT.center = LARGEUR_FENETRE // 2 - DECALAGE_POS_X_BOUTONS_PERDU,\
    HAUTEUR_FENETRE // 2 + DECALAGE_POS_Y_BOUTONS_PERDU

LARGEUR_BOUTON_PERDU = 420
HAUTEUR_BOUTON_PERDU = 150
...
INTENSITE_PESANTEUR_NIVEAU = [9.81, 1.62, 22]
...
NOMBRE_METEORITES_NIVEAU = [10, 15, 20]
